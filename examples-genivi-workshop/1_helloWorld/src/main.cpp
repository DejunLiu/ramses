...
int main(int argc, char* argv[])
{
    ...
    effectDescription.setVertexShaderFromFile("res/ramses-example-workshop-color.vert");
    effectDescription.setFragmentShaderFromFile("res/ramses-example-workshop-color.frag");
