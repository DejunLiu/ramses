...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    addTexturedQuad({ A, B, C, D }, client, *scene, "res/ramses-example-workshop-cube-1.png", *renderGroup, *groupNode, *effect, *textureCoordsArray, ramses::streamSource_t(1));
    addTexturedQuad({ B, E, D, G }, client, *scene, "res/ramses-example-workshop-cube-2.png", *renderGroup, *groupNode, *effect, *textureCoordsArray, ramses::streamSource_t(2));
    addTexturedQuad({ C, D, H, G }, client, *scene, "res/ramses-example-workshop-cube-3.png", *renderGroup, *groupNode, *effect, *textureCoordsArray, ramses::streamSource_t(3));
    addTexturedQuad({ E, F, G, H }, client, *scene, "res/ramses-example-workshop-cube-1.png", *renderGroup, *groupNode, *effect, *textureCoordsArray, ramses::streamSource_t(4));
    addTexturedQuad({ F, A, H, C }, client, *scene, "res/ramses-example-workshop-cube-2.png", *renderGroup, *groupNode, *effect, *textureCoordsArray, ramses::streamSource_t(5));
    addTexturedQuad({ F, E, A, B }, client, *scene, "res/ramses-example-workshop-cube-3.png", *renderGroup, *groupNode, *effect, *textureCoordsArray, ramses::streamSource_t(6));
