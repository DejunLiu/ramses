...
int main(int argc, char* argv[])
{
    ...
    effectDescription.setVertexShaderFromFile("res/ramses-example-workshop-texturing.vert");
    effectDescription.setFragmentShaderFromFile("res/ramses-example-workshop-texturing.frag");
    ...
    ramses::FontInstanceId fontInstance = fontRegistry.createFreetype2FontInstance(font, 60);
    ...
    const ramses::TextLineId textId = textCache.createTextLine(positionedGlyphs, *effect);
    ...
    textLine->meshNode->getAppearance()->setInputValueVector4f(colorInput, 0.1f, 0.05f, 0.7f, 1.0f);
    ...
    */
    ...
    addTexturedQuad({ A, B, C, D }, client, *scene, "res/ramses-example-workshop-cube-1.png", *renderGroup, *groupNode, *effect, *textureCoordsArray);
    addTexturedQuad({ B, E, D, G }, client, *scene, "res/ramses-example-workshop-cube-2.png", *renderGroup, *groupNode, *effect, *textureCoordsArray);
    addTexturedQuad({ C, D, H, G }, client, *scene, "res/ramses-example-workshop-cube-3.png", *renderGroup, *groupNode, *effect, *textureCoordsArray);
    addTexturedQuad({ E, F, G, H }, client, *scene, "res/ramses-example-workshop-cube-1.png", *renderGroup, *groupNode, *effect, *textureCoordsArray);
    addTexturedQuad({ F, A, H, C }, client, *scene, "res/ramses-example-workshop-cube-2.png", *renderGroup, *groupNode, *effect, *textureCoordsArray);
    addTexturedQuad({ F, E, A, B }, client, *scene, "res/ramses-example-workshop-cube-3.png", *renderGroup, *groupNode, *effect, *textureCoordsArray);
